...
class Tutorial {
  constructor() {
    ...
    this.steps = [
      {
        title: 'ברוכים הבאים למפת השבילים של הגליל!',
        content: 'בואו נלמד יחד איך להשתמש במפה כדי לתכנן מסלולי ברשת השבילים של הגליל והגולן',
        target: '.help-tutorial-btn',
        position: 'center'
      },
      {
        title: 'חיפוש מיקום',
        content: 'השתמשו בשדה החיפוש כדי לנווט למקומות שונים במפה. נסו להקליד "דפנה" או "שדה נחמיה"',
        target: '.search-input-group',
        position: 'bottom'
      },
      {
        title: 'בחירת קטעי מסלול',
        content: 'לחצו על קטעי המפה כדי להוסיף אותם למסלול שלכם. הקטעים הנבחרים יוצגו בכחול כהה',
        target: '#map',
        position: 'left',
